          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ auth()->user()->photo ? asset(auth()->user()->photo) : asset('assets/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" style="object-fit: cover; width: 40px !important; height: 40px !important;">
              </div>
            </a>
